...
public class TrackingRestControllerImpl implements TrackingRestController {
    ...
    public CompletableFuture<ResponseEntity<?>> startGymSession(@RequestBody StartGymSessionMessage message) {
        return trackingService.startGymSession(message)
    ...
    public CompletableFuture<ResponseEntity<?>> endGymSession(@RequestBody EndGymSessionMessage message) {
        return trackingService.endGymSession(message)
                .thenApply(session -> ResponseEntity.ok(
                        Map.of(
    ...
    public CompletableFuture<ResponseEntity<?>> getGymCount() {
        return trackingService.getGymCount()
    ...
    public CompletableFuture<ResponseEntity<?>> getActiveSessions() {
        return trackingService.getActiveSessions()
